...
(0, vitest_1.describe)("isString", function () {
    (0, vitest_1.it)("should return true when value is a string", function () {
        (0, vitest_1.expect)((0, index_1["default"])("foo")).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
