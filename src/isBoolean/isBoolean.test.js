...
(0, vitest_1.describe)("isBoolean", function () {
    (0, vitest_1.it)("should return true when value is a boolean", function () {
        (0, vitest_1.expect)((0, index_1["default"])(true)).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
