...
(0, vitest_1.describe)("isUndefined", function () {
    (0, vitest_1.it)("should return true when value is undefined", function () {
        (0, vitest_1.expect)((0, index_1["default"])(undefined)).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
