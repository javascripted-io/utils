...
(0, vitest_1.describe)("isError", function () {
    (0, vitest_1.it)("should return true when value is an Error", function () {
        (0, vitest_1.expect)((0, index_1["default"])(new Error())).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
