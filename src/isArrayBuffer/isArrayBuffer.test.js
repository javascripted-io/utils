...
(0, vitest_1.describe)("isArrayBuffer", function () {
    (0, vitest_1.it)("should return true when value is an array", function () {
        (0, vitest_1.expect)((0, index_1["default"])(new ArrayBuffer(2))).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
