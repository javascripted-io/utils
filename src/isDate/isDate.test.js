...
(0, vitest_1.describe)("isDate", function () {
    (0, vitest_1.it)("should return true when value is a Date", function () {
        (0, vitest_1.expect)((0, index_1["default"])(new Date())).toBe(true);
    });
    vitest_1.it.each([
        ["Infinity", Infinity],
        ["-Infinity", -Infinity],
